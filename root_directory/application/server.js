...
// port 3000 so i dont think that would cause this to not run and only hit the catch. maybe its running this post every time i run 
//the server and its not waiting for an upload? that might be it.. maybe everything is in the right spot but its just running every time
// and there is no file to be posted. that could be why there is a catch err. 
